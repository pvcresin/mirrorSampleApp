...
var _screenfull = __webpack_require__(20);
    ...
    this.on('updated', function () {
        if (_this.currentPage === _this.PAGE.SELECT) {
            if (!_this.isSwipeListener) {
                var hammer = new Hammer(_this.refs.videoContainer);
